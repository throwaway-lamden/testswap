# you must transfer 0.01 TAU and the equivalent in your Token to ctx.this to start liquidity. It's a hack, but I really don't want to think about liquidity logic any more
